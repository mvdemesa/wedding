...
const WEDDING_CONFIG = {
  ...
  story: {
    ...
    paragraphs: [
      ...
      "Then, on the magical evening of October 5, 2025, beneath the dazzling lights of HongKong, Mike asked the question they had both been waiting for.",
      "She said yes.",
    ...
    milestones: [
      ...
      { date: "Oct 5, 2025",  text: "She said yes in HongKong" },
